 ...
 * version 3 (or later).
 */
public class GLRenderContext2 implements RenderContext {
	 ...
	 *            this object.
	 */
	public GLRenderContext2(GLAutoDrawable drawable) {
	...
	private void setMaterial(Material m) {
		...
		if(m != null && m.shader != null) {
			...
			String lightString = "light_positions[" + 0 + "]";			
